...
#
# Finally, modify your greet_backwards method to say the person's name twice. For our 'Amanda' example,
# you should get:
#
# Hello, adnamAadnamA! Welcome home.
#
# Notice that we would have had to modify four lines of code if we didn't have the greet_backwards method!
# This is just one reason methods are useful.
